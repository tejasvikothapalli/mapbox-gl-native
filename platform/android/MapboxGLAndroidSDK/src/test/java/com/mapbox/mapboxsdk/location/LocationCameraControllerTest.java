...
public class LocationCameraControllerTest {
  ...
  public void transition_locationIsNull() {
    ...
    camera.setCameraMode(TRACKING, null, listener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
  ...
  public void transition_notTracking() {
    ...
    camera.setCameraMode(NONE, location, listener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
  ...
  public void transition_trackingChanged() {
    ...
    camera.setCameraMode(TRACKING, location, listener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
    verify(listener).onLocationCameraTransitionFinished(TRACKING);
    verify(mapboxMap)
      .animateCamera(any(CameraUpdate.class), any(Integer.class), any(MapboxMap.CancelableCallback.class));
  }
  ...
  public void transition_trackingNotChanged() {
    ...
    camera.setCameraMode(TRACKING_GPS_NORTH, location, listener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
  ...
  public void transition_mapboxAnimateBearing() {
    ...
    camera.setCameraMode(TRACKING_GPS, location, listener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
  ...
  public void transition_customAnimation() {
    ...
    camera.setCameraMode(TRACKING, location, null, 1200, 14.0, 13.0, 45.0);
    verify(mapboxMap)
