...
public final class LocationComponent {
  ...
  public void setCameraMode(@CameraMode.Mode int cameraMode,
    ...
    setCameraMode(cameraMode, transitionListener, TRANSITION_ANIMATION_DURATION_MS, null, null, null);
  }
  ...
  public void setCameraMode(@CameraMode.Mode int cameraMode,
    ...
    locationCameraController.setCameraMode(
      cameraMode, lastLocation, new CameraTransitionListener(transitionListener),
      transitionDuration,
      zoom, bearing, tilt);
